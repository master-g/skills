...
Use this `:root` block for new compositions. (Templates vary slightly in gray naming — `--gray-150` vs `--gray-50` — but the hex values are identical across all 20 files. When extending an existing template, follow _its_ names.)
